...
const RAW_SEEDS: vector<u64> = vector[
    9334618346840842905, 10424100709723369767, 9443182695686696458, 17933673198744876582,
    11342960890024317363, 10482980246973705466, 5290281280504745347, 10228930864023155047,
    8624286824275906926, 11253583944051605563, 17163634629999896190, 4535784743480959579,
];
const Z_MAGS: vector<u256> = vector[
    15117235107641002, 163891274124802620, 29873324118984607, 1913944434959197400,
    292121516417100300, 172005755456868860, 562796526532284100, 137067939871446830,
    81496571805477260, 279470226379301250, 1479094706384868500, 687495131945207100,
];
const Z_NEG: vector<bool> = vector[
    false, false, false, false, false, false, true, false, true, false, false, true,
];
const N_MAGS: vector<u256> = vector[
    522675852661461503, 745836911187203930, 544809986178476910, 3370916652438796100,
    938182274625650450, 758008633185303290, 344194789798426150, 705601909807170245,
    377755142291784110, 919205339568951875, 2718642059577302750, 531242697917810650,
];
const N_NEG: vector<bool> = vector[
