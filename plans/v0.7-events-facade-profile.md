# Gaussian Package v0.7 Specification

**Branch**: `feat/v0.7-events-facade-profile`  
...
| 2 | Events module + integration | #21 | 30 min | 🟡 |
| 3 | Core facade | #22 | 20 min | ⬜ |
| 4 | Profile module | #23 | 15 min | ⬜ |
| 5 | PDF dense test | #24 | 15 min | ⬜ |
| 6 | PPF fuzzing + sort helper | #25 | 30 min | ⬜ |
| 7 | Sampler strict test | #26 | 20 min | ⬜ |
| 8 | Python property tests | #27 | 45 min | ⬜ |
| 9 | Update docs, verify CHANGELOG | - | 20 min | ⬜ |
...
|------|--------|
| `CHANGELOG.md` | CREATE |
| `plans/v0.7-events-facade-profile.md` | CREATE |
...
✅ CLT functions emit events  
✅ Short names in facade  
✅ Strict monotonicity tests  
✅ P2 (#27) included in same release
